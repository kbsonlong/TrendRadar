...
class HTMLRenderer(BaseRenderer):
    ...
    def configure(self, config: Dict[str, Any]) -> bool:
        ...
        self.output_dir = config.get('output_dir', 'output/html')
        ...
        try:
            ...
            logger.info(f"HTML 渲染器配置完成: {self.template_dir}")
            return True
            
        except Exception as e:
            logger.error(f"HTML 渲染器配置失败: {str(e)}")
            return False
    ...
    def render(
        ...
        try:
            ...
            if output_path:
                ...
                logger.info(f"HTML 文件已保存: {full_output_path}")
            
            return rendered_content
            
        except TemplateNotFound:
            logger.error(f"模板未找到: {template_name}.html")
            return ""
        except Exception as e:
            logger.error(f"HTML 渲染失败: {str(e)}")
            return ""
